...
export class CoinDetailsComponent implements OnInit {
  ...
  constructor(private cryptoService: CryptoService, private activatedRoute : ActivatedRoute, private currencyService : CurrencyService) { }
  ...
  getCoinData(){
    this.cryptoService.getCurrencyById(this.coinId)
    .subscribe(res=>{
  ...
  getGraphData(days:number){
    this.days = days
    this.cryptoService.getGrpahicalCurrencyData(this.coinId,this.currency,this.days)
    .subscribe(res=>{
      setTimeout(() => {
